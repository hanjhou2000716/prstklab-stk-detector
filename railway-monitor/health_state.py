...
HEALTH_STATE: dict[str, Any] = {
    ...
    "delivery": {"status": "not_checked", "last_trace_id": None, "last_outbox_status": None, "last_receipt_status": None, "scan_status": "not_checked", "candidate_type": "none", "notification_expected": False, "notification_status": "not_checked", "notification_reason": "not_checked", "delivered_count": None, "failed_count": None, "last_processed_at": None, "last_candidate_at": None, "last_telegram_attempt_at": None, "counts": {}, "last_updated_at": None, "last_error": None, "storage": {"status": "not_checked", "durable_volume_detected": False, "state_parent_writable": False, "state_parent_exists": False, "restart_continuity": {"status": "not_checked", "previous_started_at": None, "error": None}, "fail_closed_for_high_risk": True}},
    ...
    "gmail": {
        ...
        "scan_status": "not_checked", "candidate_type": "none",
        "notification_expected": False, "notification_status": "not_checked",
        "notification_reason": "not_checked", "delivered_count": None, "failed_count": 0,
        "last_processed_at": None, "last_candidate_at": None,
        "last_telegram_attempt_at": None, "last_receipt_status": None,
        "storage": {"status": "not_checked", "durable_volume_detected": False, "state_parent_writable": False, "state_parent_exists": False, "restart_continuity": {"status": "not_checked", "previous_started_at": None, "error": None}, "fail_closed_for_high_risk": True},
        "error": None,
    },
    "creator": {
