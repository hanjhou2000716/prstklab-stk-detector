    ...
    for rank, (_, row) in enumerate(frame.iterrows(), start=1):
        ...
        candidates.append({
            ...
            **identity,
            ...
            "financial_complete": _value(row.get("financial_complete")),
            "financial_status": _value(row.get("financial_status")),
            "eps_ytd": _value(row.get("eps_ytd")),
            "total_net_income_ytd": _value(row.get("total_net_income_ytd")),
            "total_equity": _value(row.get("total_equity")),
            "annualized_quality_ratio": _value(row.get("annualized_quality_ratio")),
            "quality_basis": _value(row.get("quality_basis")),
            "calculation_basis": _value(row.get("calculation_basis")),
            "financial_period": _value(row.get("reporting_period")),
