...
| DEBT-039-03 | Full repository regression and all original P0 DoDs not rerun on this checkpoint | Run after the stacked PRs are reconciled on latest main; current matrix is explicit in `docs/p0-traceability-2026-08-15.md` | OPEN |
