...
| News artifact/release binding | `src/release_manifest.py`, `src/artifact_contract.py` | yes | additive release artifact when canonical payload exists | `data/news.json` | release-bound | release gate only | partially_integrated |
