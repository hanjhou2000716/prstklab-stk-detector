...
| Railway health contract | `src/railway_health_contract.py`, `railway-monitor/app.py`, `railway-monitor/runtime_config.py` | yes | monitor health boundary + redacted runtime configuration | bounded status/retry/heartbeat/configuration state | source health | observability only | partially_integrated |
