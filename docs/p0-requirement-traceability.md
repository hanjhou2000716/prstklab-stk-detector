...
| P0-18 external alert trust boundary | `src/external_alert.py`, `tests/test_p0_18_external_alert_contract.py` | contract evidence pending CI | signed canonical payload; HTTPS provenance; official/market-sync high-risk gate | NEEDS_REVERIFY |
