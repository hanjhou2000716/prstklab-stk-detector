...
| P0-12 multilingual event matching | event normalization and keyword groups | Current evidence audit pending | no false cross-market classification | NEEDS_REVERIFY |
