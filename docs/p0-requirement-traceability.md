...
| P0-14 market synchronization evidence | `tests/test_p0_14_market_sync_contract.py` | `4d71e54`; targeted 30 passed; CI evidence pending | fresh timestamp-aligned market evidence is required; oil/Brent/WTI uses the 5% threshold; graph remains conditional without sync | NEEDS_REVERIFY |
