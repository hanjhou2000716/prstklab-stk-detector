...
| P0-17 / `REQ-P0-17-DOD-01..03` | `src/creator_photo_delivery.py`, `src/alert_card_renderer.py` | #573? legacy P0 stack | renderer/notification fixtures | real 1080×1350 photo delivery pending | renderer failure never sends blank card | NEEDS_REVERIFY |
