...
| FinancialJuice Mini App evidence card | `site/app.js`, `site/styles.css` | static UI contract plus JavaScript syntax check | `tests/test_financialjuice_mini_app_contract.py` | vendor priority remains separate from PRStK risk; release/snapshot/observation lineage and waiting state remain visible | PASS |
