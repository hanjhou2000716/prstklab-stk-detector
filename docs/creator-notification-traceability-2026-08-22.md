...
| FinancialJuice Mini App evidence card | `site/app.js`, `site/styles.css` | static UI contract plus JavaScript syntax check | `financialjuice-miniapp-ui-2026-08-22.json` (quality run 32548163338; security run 32548163385) | vendor priority remains separate from PRStK risk; release/snapshot/observation lineage and waiting state remain visible | PASS |
