...
| REQ-ADD-024 | health baseline state | `railway-monitor/app.py` | targeted monitor health contract; pending remote CI | first-cycle values remain not_checked | IN_PROGRESS |
