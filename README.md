...
- **量化觀察清單**：台美股動能、裸 K 價格結構、三維共振與獨立價值投資池；僅作研究排序，不是推薦名單。
...
| 全市場量化研究 | 工作日 13:30 | 台美股動能、裸 K、三維共振、獨立價值投資池與研究清單價格欄位；預留至 14:45 盤後快報的處理時間 |
...
官方／價格警報每 15 分鐘會將下列**一手來源**讀成候選事件，再交由去重、時效與市場快照流程處理；來源失敗會記錄資料缺口，不以舊聞補送。官方標題會附原始連結，但只在符合重大性門檻時才推播 Telegram。

| 來源 | 接入內容 | 納入快訊的門檻 |
|---|---|---|
| Federal Reserve RSS | FOMC、利率、貨幣政策 | 政策／利率／經濟預測公告 |
| BLS RSS | CPI、非農、就業、PPI、進出口物價 | 重大總經統計公告 |
| EIA RSS | 石油、天然氣、能源展望 | 能源供給、油價或通膨背景的重要官方發布 |
| SEC EDGAR | NVDA、TSM、ASML、AMD、AVGO 的最新財務申報 | 10-K、10-Q，或具 2.02 財務結果欄位的 8-K／6-K |
| TWSE OpenAPI | 證交所官方新聞 | 重大訊息、停復牌、半導體或市場結構相關公告 |
| USGS GeoJSON | 即時重大地震 | 全球 M7 以上，或台日韓菲區域 M6 以上 |

Reuters、Bloomberg 等新聞來源必須使用正式商業 API 授權；系統不會爬取其網站。GDELT 等聚合來源若日後啟用，僅能作為候選線索，仍須由上述官方或已授權來源二次核對。
...
價值投資不再由動能、裸 K 或三維共振的結果回頭挑選。它有自己的公開母體與資料管線：

| 市場 | 母體 | 基本面主要來源 | 研究規則 |
|---|---|---|---|
| 台股 | 元大 0050 + 0051 最新官方 PCF／持股表 | TWSE OpenAPI 的上市公司財報、股利及本益比欄位 | 最新申報期淨利、ROE、公開本益比與現金回饋資料；「三年 ROE 穩定」只有在歷史資料充足時才會標示 |
| 美股 | Vanguard VOO 官方持股表 | SEC EDGAR CompanyFacts | 最近三個可得年度的淨利、ROE、現金股利與最新年度欄位，並保留申報年度 |

台股以新台幣 **50 億元**、美股以美元 **5 億元**作為「規模獲利」的初始門檻；ROE 達 17%、現金回饋達 20% 為公開覆核條件。本益比只作估值欄位顯示，並非買賣訊號。若來源無法取得、資料期別不一致或尚不足三年，系統會保留缺口，不會補造分數或標成長期穩定。
