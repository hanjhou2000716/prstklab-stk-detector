...
| 市場 | 基本面來源 | 覆核條件 |
|---|---|---|
| 台股 | TWSE OpenAPI 最新財報／本益比，加上 MOPS 歷史 EPS 與股利公告 | 三年年度 EPS、最近四季 EPS、三年配息均為正；最新申報期淨利至少 50 億元、ROE 達 17%、本益比可核對；歷史 ROE 尚未完成時不假稱三年穩定 |
| 美股 | SEC EDGAR CompanyFacts 與 VOO 官方持股表 | 最近可得年度淨利至少 5 億美元、ROE、現金股利／配息與本益比等公開欄位 |

璞玉價值只保留通過品質門檻，且近三月五項熱度皆未落在母體最高 10% 的標的。分數為「品質與獲利 50、合理估值 15、去熱門化 35、來源完整 5」，最多 100。護城河不是可由單一 API 證明的數字；系統會明確標示仍需閱讀年報與產業資料，而不是假稱已自動判定。
